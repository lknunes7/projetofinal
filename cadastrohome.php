    ...
    <div class="box">
        <form action="cadastrohome.php" method="POST">
            <fieldset>
                ...
                <label style="color: #D7C3B3; font-size: 15px; border: 4px solid #31683E; border-radius: 3px; background-color: #31683E;"for="datanasc">Data de Nascimento:</label>
                ...
                <div>
                    <br>
                    <h6 style="color: whitesmoke; text-align: center;">Já possuí conta?<p></p><a href="loginhome.html" style="color: #D7C3B3; align-items: center; font-size: x-small;">Logar</a></h6>
                </div>
